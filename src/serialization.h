...
/*
	...
	29: Add zstd and other size and perormance optimizations
*/
...
void compressZstd(const std::string &data, std::ostream &os, int level = 0, Buffer<u8> *dict = nullptr);
void decompressZstd(std::istream &is, std::ostream &os, size_t limit = 1 << 26, Buffer<u8> *dict = nullptr);
